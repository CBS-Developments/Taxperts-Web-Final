                                          ...
                                          child: Padding(
                                            ...
                                            child: Column(
                                              children: [
                                                Row(
                                                  children: [
                                                    Text('Estimate Individual Tax Payable 2023/2024',style: TextStyle(color: Colors.white,fontWeight: FontWeight.w600,fontSize: 20),),
                                                  ],
                                                ),
                                                Row(
                                                  children: [
                                                    Text('The tax year is starts on 01st ',style: TextStyle(color: Colors.white,fontSize: 12),),
                                                    Text('April and ends at 31st March',style: TextStyle(color: Colors.white,fontWeight: FontWeight.w600,fontSize: 12),),
                                                  ],
                                                ),
                                              ],
                                            ),
                                      ...
                                      children: [
                                        ...
                                        ElevatedButton(
                                          ...
                                          style: ElevatedButton.styleFrom(
                                            ...
                                            // fixedSize: const Size(
                                            //     220, 45), // Set the width and height
                                            primary: Colors.redAccent, // Set the background color to green
                                            shape: RoundedRectangleBorder(
                                              borderRadius: BorderRadius.circular(
                                                  30), // Set the border radius
                                            ),
